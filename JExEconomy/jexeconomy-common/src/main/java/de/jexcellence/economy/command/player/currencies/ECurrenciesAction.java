 ...
 *
 * <p>This enum serves as a comprehensive catalog of all operations that can be performed
 ...
 *
 * <p><strong>Action Categories:</strong>
 * <ul>
 ...
 *
 * <p>This enum is designed to work seamlessly with the command parsing system, allowing
 ...
 *
 * <p>This action enables administrators to define new currencies with custom
 ...
 *
 * <p>This action allows administrators to permanently delete currencies from
 ...
 *
 * <p>This action enables administrators to update currency properties such as
 ...
 *
 * <p>This action provides detailed information about a currency including all
 ...
 *
 * <p>This action provides comprehensive help documentation including command syntax,
 ...
 *
 * <p>This action provides a structured listing of all currencies currently
	 ...
	 *
	 * <p><strong>Overview Content:</strong>
	 * <ul>
 ...
 *
 * <p>This method provides case-insensitive lookup of currency actions based on
 ...
 *
 * <p>This method provides a standardized lowercase string representation of the
 ...
 *
 * <p>This method identifies actions that permanently modify or remove data
 ...
 *
 * <p>This method identifies actions that should be restricted to users with
	 ...
	 *
	 * <p><strong>Administrative Actions:</strong>
	 * <ul>
	 ...
	 * </ul>
	 *
	 * <p><strong>Non-Administrative Actions:</strong>
	 * <ul>
	 ...
	 * </ul>
	 *
	 * <p><strong>Permission Considerations:</strong>
	 * <ul>
