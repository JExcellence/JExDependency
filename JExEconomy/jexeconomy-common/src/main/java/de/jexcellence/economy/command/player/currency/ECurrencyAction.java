 ...
 *
 * <p>This enum serves as a comprehensive catalog of operations that can be performed on
 ...
 *
 * <p>This enum is designed to be extensible, allowing for future addition of currency-specific
 ...
 *
 * <p>This action provides players with detailed guidance on how to use currency-related
	 ...
	 *
	 * <p><strong>Help Content Features:</strong>
	 * <ul>
	 ...
	 * </ul>
	 *
	 * <p><strong>Content Organization:</strong>
	 * <ul>
 ...
 *
 * <p>The returned string is guaranteed to be lowercase and consistent across
 ...
 * <p>This method identifies actions that should be restricted to users with
	 ...
	 *
	 * <p><strong>Permission Philosophy:</strong>
	 * <ul>
 ...
 *
 * <p>As new actions are added to this enum, this method should be updated to
 ...
 *
 * <p>This method identifies actions that only retrieve and display information
	 ...
	 *
	 * <p><strong>Informational Action Characteristics:</strong>
	 * <ul>
	 ...
	 * </ul>
	 *
	 * <p><strong>Usage in System Design:</strong>
	 * <ul>
