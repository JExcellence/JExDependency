...
public class MigrationCommand implements CommandExecutor, TabCompleter {
    ...
    private final JExEconomy plugin;
    private final VaultMigrationManager migrationManager;
    
    // Color constants for consistent messaging
    private static final String PREFIX = ChatColor.GOLD + "[JExEconomy] " + ChatColor.RESET;
    ...
    public MigrationCommand(@NotNull JExEconomy plugin) {
        this.plugin = plugin;
...
/**
    ...
    private void handleStartMigration(@NotNull CommandSender sender, @NotNull String[] args) {
        ...
        sender.send(PREFIX + INFO + "Starting Vault to JExEconomy migration...");
...
/**
    ...
    private void handleSupportedPlugins(@NotNull CommandSender sender) {
        ...
        sender.send(PREFIX + INFO + "JExEconomy can still provide Vault compatibility even without migration.");
    }
...
/**
    ...
    private void handleMigrationInfo(@NotNull CommandSender sender) {
        sender.send(PREFIX + INFO + "JExEconomy Vault Migration System");
        sender.send(PREFIX + INFO + "=====================================");
        sender.send(PREFIX + INFO + "This system allows you to migrate from existing");
        sender.send(PREFIX + INFO + "Vault-based economy plugins to JExEconomy while");
...
/**
    ...
    private void sendMigrationHelp(@NotNull CommandSender sender) {
        sender.send(PREFIX + INFO + "JExEconomy Migration Commands:");
        sender.send(PREFIX + INFO + "================================");
