 ...
 *
 * <p>This view provides a comprehensive list of all available currencies with their symbols,
 ...
 *
 * <p>Users can navigate from the currencies action overview to this view to see all currencies,
 ...
 *
 * <p>The view will display all available currencies in a paginated format and provide
 ...
 *
 * <p>This key is used to load localized strings for the currencies overview interface,
 ...
 * <p>This method creates a visual representation of a currency including its icon,
	 ...
	 *
	 * <p><strong>Entry Information:</strong>
	 * <ul>
 ...
 *
 * <p>Clicking on a currency entry opens the {@link CurrencyDetailView} with the
 ...
 *
 * <p>This method is called after the pagination and navigation elements are rendered.
 ...
 *
 * <p>This method can be extended to add additional UI elements such as:
	 * <ul>
