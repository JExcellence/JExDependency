 ...
 * <ul>
 *   <li>Integrates with JExEconomyImpl plugin repositories for data persistence</li>
 ...
 * @version 2.0.0
 * @since 2.0.0
 * @see de.jexcellence.economy.JExEconomyImpl
 * @see Currency
 * @see UserCurrency
 */
public class CurrencyCommandHandler {
	 ...
	 * </p>
	 *
	 * @param jexEconomyImpl the main JExEconomyImpl plugin instance providing access to services, must not be null
	 * @throws IllegalArgumentException if jexEconomyImpl is null
	 */
	public CurrencyCommandHandler(final @NotNull JExEconomyImpl jexEconomyImpl) {
