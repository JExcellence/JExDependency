...
/**
 * Enumeration defining permission nodes for individual currency command operations within the JExEconomyImpl system.
 * <p>
...
public enum ECurrencyPermission implements IPermissionNode {
	 ...
	 * within the JExEconomyImpl plugin's permission framework.
	 * </p>
	 *
