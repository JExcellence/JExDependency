 ...
 * <p>
 * This adapter serves as the main entry point for all currency-related operations within the JExEconomyImpl system.
 ...
 * <p>
 * This implementation uses the JExEconomyImpl plugin's repository layer for data access and leverages
...
public class CurrencyAdapter implements ICurrencyAdapter {
     ...
     */
    public CurrencyAdapter(final @NotNull JExEconomyImpl jexEconomyImpl) {
