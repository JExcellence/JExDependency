...
public class PermissionsService {
	...
	public PermissionsService(
		...
		this.rdq = rdq;
		try {
			ConfigManager cfgManager = new ConfigManager(rdq.getImpl(), FOLDER_PATH);
			ConfigKeeper<PermissionsSection> cfgKeeper = new ConfigKeeper<>(cfgManager, FILE_NAME, PermissionsSection.class);
			this.permissions = cfgKeeper.rootSection.getPermissions();
		} catch (
	...
	public boolean addPermissionSet(
		...
		if (
            ...
            I18n.create(
                    MessageKey.of("admin_permissions_overview_ui.errors.plugin_not_found"),
                    player
            ).includePrefix().withPlaceholder("plugin_name", pluginName).sendMessage();
			return false;
		}
		...
		if (
            ...
            I18n.create(
                    MessageKey.of("admin_permissions_overview_ui.errors.no_luckperms_installed"),
                    player
