...
public class RankProgressionManager {
	...
	public RankProgressionManager(final @NotNull RDQImpl rdq) {
		this.rdq = rdq;
	...
	public void startRankProgression(
		...
		try {
            ...
            I18n.create(
                    MessageKey.of("rank_progression.started"),
                    player
            ).withPlaceholders(
                    Map.of(
	...
	public void openRequirementsView(
		...
		try {
            ...
            I18n.create(
                    MessageKey.of("rank_progression.requirements_view_opened"),
                    player
            ).includePrefix().withPlaceholder("rank_name", rankNode.rank.getIdentifier()).sendMessage();
	...
	private void processRankAssignmentWithPlayer(
		...
		try {
            ...
            I18n.create(
                    MessageKey.of(messageKey),
                    player
            ).includePrefix().withPlaceholder("rank_name", rank.getIdentifier()).sendMessage();
	...
	private void handleIncompleteRequirements(
		...
		try {
            ...
            I18n.create(
                    MessageKey.of("rank_progression.requirements_incomplete"),
                    player
            ).withPlaceholders(
                    Map.of(
	...
	private void showIncompleteRequirements(
		...
		try {
			...
			for (final RRankUpgradeRequirement requirement : upgradeRequirements) {
                ...
                I18n.create(
                        MessageKey.of("rank_progression.requirement_incomplete"),
                        player
	...
	private void sendNoRequirementsMessage(final @NotNull Player player, final @NotNull RRank rank) {
		try {
            I18n.create(
                    MessageKey.of("rank_progression.no_requirements"),
                    player
            ).includePrefix().withPlaceholder("rank_name", rank.getIdentifier()).sendMessage();
		} catch (final Exception exception) {
