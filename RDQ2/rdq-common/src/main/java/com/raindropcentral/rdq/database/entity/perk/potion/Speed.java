...
/** Speed toggleable passive perk. */
@Entity
@DiscriminatorValue("SPEED")
public class Speed extends PotionEffectPerk {

    protected Speed() { super(); }

    public Speed(final @NotNull PerkSection perkSection) {
        super(
                EPerkIdentifier.SPEED.getIdentifier(),
                perkSection,
