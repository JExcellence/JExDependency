...
public class RRank extends AbstractEntity {
    ...
    public RRank(@NotNull String identifier, @NotNull String displayNameKey,
                 ...
                 @NotNull IconSection icon, boolean isInitialRank,
                 int tier, int weight, @Nullable RRankTree rankTree) {
    ...
    public boolean addUpgradeRequirement(@NotNull RRankUpgradeRequirement upgradeRequirement) {
        ...
        var added = this.upgradeRequirements.add(upgradeRequirement);
    ...
    public boolean removeUpgradeRequirement(@NotNull RRankUpgradeRequirement upgradeRequirement) {
        Objects.requireNonNull(upgradeRequirement, "upgradeRequirement cannot be null");
        var removed = this.upgradeRequirements.remove(upgradeRequirement);
    ...
    public void replaceUpgradeRequirements(@NotNull Collection<RRankUpgradeRequirement> newRequirements) {
        Objects.requireNonNull(newRequirements, "newRequirements cannot be null");
        this.upgradeRequirements.clear();
        for (var req : newRequirements) {
