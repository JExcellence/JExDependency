...
public class RPlayerStatistic extends BaseEntity {
    ...
    /**
     * Server association for scoping statistics to a specific server instance.
     * Allows tracking player statistics per server for multi-server environments.
     */
    ...
    /**
     * Provides the server association for this statistic aggregate.
     *
     * @return server that owns these statistics, or null if not server-scoped
     */
    public @Nullable RCentralServer getRCentralServer() {
        return this.rCentralServer;
    }

    /**
     * Updates the server association for scoping statistics to a specific server.
     *
     * @param rCentralServer server to associate with this aggregate
     */
    public void setRCentralServer(final @Nullable RCentralServer rCentralServer) {
        this.rCentralServer = rCentralServer;
    }
