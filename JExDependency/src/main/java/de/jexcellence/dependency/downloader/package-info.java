 ...
 * <p>
 * Coordinates are gathered from the plugin bundle via the {@code dependency/*.yml} files that the
 ...
 * <p>
 * When downloads begin, {@link de.jexcellence.dependency.downloader.DependencyDownloader} tries any
 ...
 * <p>
 * The downloader performs strict validation: it skips work if a previously downloaded file already
 ...
 * <p>
 * JVM system properties control where those downloads are injected. {@code JEDependency} selects the
 ...
 * packages.
 * <p>
 * Runtime classpath injection always favours remapped outputs when they are available. During the
