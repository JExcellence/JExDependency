 ...
 * <p>
 * {@link de.jexcellence.dependency.loader.PaperPluginLoader} is instantiated by Paper before the
 ...
 * class loader state.
 * <p>
 * Because both the loader and the plugin managers read the identical YAML sources and persist into
