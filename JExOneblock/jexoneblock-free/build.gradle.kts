...
version = "1.0.3"
description = "JExOneblock Free - Free edition of Oneblock skyblock gamemode"
...
tasks.named<ShadowJar>("shadowJar") {
    ...
    // Include common resources with translations
    from(project(":JExOneblock:jexoneblock-common").sourceSets.main.get().resources)
    
    // Copy common translations to free build
...
publishing {
    publications {
        create<MavenPublication>("mavenShadow") {
            ...
            artifactId = "jexoneblock-free"
            version = project.version.toString()
            pom {
                name.set("JExOneblock Free")
