...
/**
 * Shared reflection helpers for {@link SkillBridge} implementations.
 *
 * @author ItsRainingHP
 * @since 2.0.0
 * @version 1.0.0
 */
abstract class AbstractReflectionSkillBridge implements SkillBridge {
    ...
    protected final @Nullable Object resolveEnumConstant(
        final @Nullable Class<?> enumClass,
        ...
        for (final Object constant : constants) {
            ...
            if (target.equals(normalizeLookupKey(constant.toString()))) {
                return constant;
            }
        }
