...
import com.raindropcentral.rplatform.utility.itembuilder.skull.UnifiedHeadBuilder;
...
/**
 * Factory facade that selects builder implementations matching the detected server capabilities.
 *
 * <p>The factory inspects {@link ServerEnvironment} once per call to determine whether Paper
 * features are available and routes creation to the proper modern or legacy builder. Callers use
 * these helpers to avoid duplicating environment checks throughout menu and UI code.</p>
 *
 * @author JExcellence
 * @since 1.0.0
 * @version 1.0.1
...
public class UnifiedBuilderFactory {
     ...
     * @return legacy or modern head builder depending on runtime
     */
    @Deprecated
     ...
     * This builder prevents {@link NoSuchMethodError} by using reflection and fallbacks.
     *
     * @return a new {@link SafeHeadBuilder}
     */
    @NotNull
     ...
     *
     * @return a new {@link UnifiedHeadBuilder}
     */
    @NotNull
     ...
     * @return a new {@link UnifiedHeadBuilder} with the player's head
     */
    @NotNull
     ...
     * @return a new {@link UnifiedHeadBuilder} with the offline player's head
     */
    @NotNull
     ...
     * @return a new {@link UnifiedHeadBuilder} with the custom texture
     */
    @NotNull
     ...
     *
     * @return potion builder aligned with the runtime platform
     */
     ...
     *
     * @param material material used to create the item stack
     * @return unified item builder targeting the runtime platform
     */
