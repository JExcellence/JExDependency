...
public class ResistancePerkService implements PerkEventListener {

    private final PerkManager perkManager;
    private final PerkEventBus perkEventBus;

    public ResistancePerkService(@NotNull PerkManager perkManager, @NotNull PerkEventBus perkEventBus) {
    ...
    private void applyResistanceEffect(@NotNull Player player) {
        LoadedPerk perk = perkManager.getPerk("resistance");
        if (perk == null) {
            return;
        }
    ...
    private void removeResistanceEffect(@NotNull Player player) {
