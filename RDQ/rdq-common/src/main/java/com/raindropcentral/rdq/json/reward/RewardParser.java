...
public class RewardParser {
	 ...
	 *   <li>Polymorphic reward types via {@link com.raindropcentral.rdq.json.reward.RewardMixin}</li>
	 * </ul>
	 ...
	 * as configured in {@link com.raindropcentral.rdq.json.reward.RewardMixin}.
	 * </p>
	 *
	 ...
	 */
	public static @NotNull AbstractReward parse(@NotNull final String json) throws IOException {
	 ...
	 */
	public static @NotNull String serialize(@NotNull final AbstractReward requirement) throws IOException {
