        ...
        public String convertToDatabaseColumn(final PerkSection perkSection) {
            try {
                ...
                final PerkSectionData data = new PerkSectionData(
                        CONVERTER_TOOL.getPrivateField(perkSection, "icon", LOGGER),
                        CONVERTER_TOOL.getPrivateField(perkSection, "perkSettingsSection", LOGGER),
                        CONVERTER_TOOL.getPrivateField(perkSection, "permissionCooldownSection", LOGGER),
                        CONVERTER_TOOL.getPrivateField(perkSection, "permissionAmplifierSection", LOGGER),
                        CONVERTER_TOOL.getPrivateField(perkSection, "cooldown", LOGGER),
                        CONVERTER_TOOL.getPrivateField(perkSection, "costSection", LOGGER),
                        CONVERTER_TOOL.getPrivateField(perkSection, "requirementSection", LOGGER),
                        CONVERTER_TOOL.getPrivateField(perkSection, "rewardSection", LOGGER),
                        CONVERTER_TOOL.getPrivateField(perkSection, "requiresOwnedArea", LOGGER)
                );
