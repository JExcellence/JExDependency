...
/**
 * Configuration section for the machine command.
 *
 * <p>Provides configuration metadata for the {@code /rq machine} command, including
 * permission nodes, command aliases, and permission inheritance relationships.
 *
 * @author JExcellence
 * @version 1.0.0
 * @since 1.0.0
 */
public class MachineCommandSection extends ACommandSection implements PermissionParentProvider {

    private static final String COMMAND_NAME = "machine";

    @CSAlways
    private Map<String, Object> permissionParents;

    /**
     * Constructs a new {@code MachineCommandSection}.
     *
     * @param environmentBuilder the evaluation environment builder
     */
    public MachineCommandSection(
        final @NotNull EvaluationEnvironmentBuilder environmentBuilder
    ) {
