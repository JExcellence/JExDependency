...
public class CompositeRequirementSection extends AConfigSection {
    ...
    /**
     * Gets the configured description for the composite requirement.
     *
     * @return the description or {@code null} if none is provided
     */
    ...
    /**
     * Indicates whether partial progress is allowed for sub-requirements.
     *
     * @return the configured flag, defaulting to {@code true} when unspecified
     */
     ...
     *
     * @return combined list of all sub-requirements in insertion order
     */
     ...
     *
     * @return the map of sub-requirements, or an empty map when none are defined
     */
     ...
     *
     * @return the minimum required, defaulting based on the resolved operator
     */
     ...
     *
     * @return the maximum required, defaulting based on the resolved operator
     */
