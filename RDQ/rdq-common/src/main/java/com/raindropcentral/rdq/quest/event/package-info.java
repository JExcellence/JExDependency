 ...
 *
 * <p>This package contains Bukkit events fired during quest operations:
 * <ul>
 ...
 * </ul>
 *
 * <p>All events are called on the main thread and follow the standard Bukkit
 * event pattern with HandlerList support.
 *
 * <p>These events can be listened to by other plugins or internal systems to
