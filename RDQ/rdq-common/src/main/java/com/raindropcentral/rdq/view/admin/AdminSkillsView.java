 ...
 *
 * <p>This view reports support state for configured skill integrations and helps administrators
...
public class AdminSkillsView extends BaseView {
    ...
    /**
     * Renders skill-plugin detection entries.
     *
    ...
    public void onFirstRender(
        ...
        final List<AdminPluginIntegrationSupport.PluginDetectionEntry> entries =
            AdminPluginIntegrationSupport.detectSkillPlugins(
