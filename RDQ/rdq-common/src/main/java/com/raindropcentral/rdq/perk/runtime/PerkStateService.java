...
/**
 * Contract for managing player perk ownership and enablement state.
 *
 * This interface consolidates behavior implemented by existing concrete services
 * (e.g., PlayerPerkStateService, DefaultPerkStateService) so callers can depend
 * on a single type. If you later decide to fully remove interfaces, inline these
 * methods into a single concrete class and update references accordingly.
 */
