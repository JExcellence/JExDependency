...
public final class PerkConfigLoader {
    ...
    public PerkConfigLoader(
        ...
        this.config = PerkConfig.defaults();
    }

    @NotNull
    public PerkConfig loadConfig() {
        ...
        try {
            ...
            var notifications = notificationSection != null
                ? new PerkConfig.NotificationConfig(
                ...
                : PerkConfig.NotificationConfig.defaults();
    ...
    private PerkType parseType(@NotNull ConfigurationSection yaml) {
        ...
        return PerkTypeRegistry.parse(typeString, configMap);
    }
