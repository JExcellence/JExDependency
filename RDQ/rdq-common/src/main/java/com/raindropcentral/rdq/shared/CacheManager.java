package com.raindropcentral.rdq.shared;
...
public final class CacheManager {
    ...
    private final Cache<String, Rank> rankCache;
    private final Cache<String, RankTree> rankTreeCache;
    ...
    @Nullable
    public Rank getRank(@NotNull String rankId) {
        return rankCache.getIfPresent(rankId);
    }

    @NotNull
    public Rank getRank(@NotNull String rankId, @NotNull Function<String, Rank> loader) {
        return rankCache.get(rankId, loader);
    }

    public void putRank(@NotNull Rank rank) {
        rankCache.put(rank.id(), rank);
    }
    ...
    @Nullable
    public RankTree getRankTree(@NotNull String treeId) {
        return rankTreeCache.getIfPresent(treeId);
    }

    @NotNull
    public RankTree getRankTree(@NotNull String treeId, @NotNull Function<String, RankTree> loader) {
        return rankTreeCache.get(treeId, loader);
    }

    public void putRankTree(@NotNull RankTree tree) {
        rankTreeCache.put(tree.id(), tree);
    }
