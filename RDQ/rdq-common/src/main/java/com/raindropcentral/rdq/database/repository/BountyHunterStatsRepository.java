    ...
    public @NotNull CompletableFuture<List<BountyHunterStats>> findTopHuntersAsync(
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            Comparator<BountyHunterStats> comparator = switch (orderBy) {
                case "total_reward_value" -> Comparator.comparing(BountyHunterStats::getTotalRewardValue).reversed();
                case "bounties_claimed" -> Comparator.comparing(BountyHunterStats::getBountiesClaimed).reversed();
                default -> Comparator.comparing(BountyHunterStats::getBountiesClaimed).reversed();
            };
            return list.stream()
                    .sorted(comparator)
                    .limit(limit)
