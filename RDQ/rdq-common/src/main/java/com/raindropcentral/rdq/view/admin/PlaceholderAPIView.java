...
/**
 * Administrative PlaceholderAPI integration view for RDQ.
 *
...
public class PlaceholderAPIView extends BaseView {
    ...
    private static final String ADMIN_COMMAND_PERMISSION = "raindropquests.command.admin";
     ...
     *
     * @return rendered layout with status and action controls
     */
    @Override
