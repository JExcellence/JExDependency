...
public class CaptisForgeSection extends AConfigSection {
    ...
    /**
     * Retrieves the cooldown time before income can be earned again while fishing.
     *
    ...
    /**
     * Retrieves the amount of fishing time required to trigger the income reward.
     *
     * @return the amount of required fishing time in ticks
     */
    ...
    /**
     * Provides the currency cost map for activating the Captis Forge perk.
     *
     * @return a map of currency identifiers mapped to their respective costs
     */
    ...
    /**
     * Provides the income definition granted when the perk is active while fishing.
     *
     * @return a map describing the income currencies and their corresponding amounts
     */
