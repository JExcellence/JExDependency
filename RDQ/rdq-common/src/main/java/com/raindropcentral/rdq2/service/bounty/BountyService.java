/*
package com.raindropcentral.rdq2.service.bounty;

import com.raindropcentral.rdq2.database.entity.bounty.BountyHunterStats;
import com.raindropcentral.rdq2.database.entity.bounty.RBounty;
import com.raindropcentral.rdq2.database.entity.player.RDQPlayer;
import com.raindropcentral.rdq2.database.entity.reward.RewardItem;
...
public interface BountyService {
    ...
    @NotNull CompletableFuture<RBounty> createBounty(
            ...
            @NotNull Set<RewardItem> rewards,
