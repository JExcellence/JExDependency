...
import com.raindropcentral.rdq2.config.perk.PerkSystemSection;
...
public final class PerkSystemState {
    ...
    private final PerkSystemSection perkSystemSection;
    private final Map<String, PerkSection> perkSections;
    private final Map<String, RPerk> perks;
