...
public class PerkTypeRegistry {
    ...
    /**
     * Parses a perk type from configuration.
     * @param typeString the type identifier
     * @param configMap the configuration map
     * @return the parsed perk type, or null if not found
     */
    public static @Nullable PerkType parse(@NotNull String typeString, @NotNull Map<String, Object> configMap) {
