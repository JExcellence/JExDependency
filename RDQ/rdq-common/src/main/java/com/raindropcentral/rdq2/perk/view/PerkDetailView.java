...
import com.raindropcentral.rdq2.perk.PerkEffect;
import com.raindropcentral.rdq2.perk.PerkRequirement;
import com.raindropcentral.rdq2.perk.PlayerPerkState;
...
public final class PerkDetailView extends BaseView {
    ...
    public void onFirstRender(final @NotNull RenderContext render, final @NotNull Player player) {
        ...
        // renderActionSlot(render, player, perk, state, RDQ, perkService);
    }
    ...
    private void renderActionSlot(RenderContext render, Player player, Perk perk, 
                                   PlayerPerkState state, RDQ RDQ, PerkService perkService) {
