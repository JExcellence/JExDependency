 ...
 * {@link com.raindropcentral.rdq2.RDQ#runSync(Runnable) runSync} block, ensuring any tree previews
 * rendered in GUIs stay aligned with the immutable configuration model.
 * </p>
 * <p>
 * Stage&nbsp;3 wires {@link com.raindropcentral.rdq2.database.repository.RRankTreeRepository} and
 * {@link com.raindropcentral.rdq2.database.repository.RRequirementRepository}, both of which
 ...
 * </p>
 */
package com.raindropcentral.rdq2.config.ranks.ranktree;
