 ...
 * features exposed to players via managers and views (for example {@link com.raindropcentral.rdq2.database.entity.bounty.RBounty}
 * tracks bounty assignments while {@link com.raindropcentral.rdq2.database.entity.player.RDQPlayer}
 ...
 * {@link com.raindropcentral.rdq2.RDQ#onEnable()} for the orchestrated startup sequence that culminates
 * in repository wiring.
 * </p>
 */
package com.raindropcentral.rdq2.database;
