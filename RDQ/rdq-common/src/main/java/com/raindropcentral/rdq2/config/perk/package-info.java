 ...
 * <p>
 * {@link com.raindropcentral.rdq2.config.perk.PerkSection} and its nested sections describe each perk's
 * metadata, requirements, and rewards before they are persisted via
 * {@link com.raindropcentral.rdq2.database.converter.PerkSectionConverter} and evaluated during gameplay.
