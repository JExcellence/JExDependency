 ...
 * <p>
 * During the asynchronous platform bootstrap (stage&nbsp;1) {@link com.raindropcentral.rdq2.RDQ}
 ...
 * {@link com.raindropcentral.rdq2.RDQ#initializeViews()} finish on the main thread (stage&nbsp;2),
 * each section can be safely materialised inside the {@link com.raindropcentral.rdq2.RDQ#runSync(Runnable)
 * runSync} boundary without blocking server ticks.
 * </p>
 * <p>
 * Repository wiring (stage&nbsp;3) invokes {@link com.raindropcentral.rdq2.database.repository.RPerkRepository}
