 ...
 * <ul>
 *   <li>{@link com.raindropcentral.rdq2.database.entity.player.RDQPlayer} keeps the canonical record
 *   of a player, including owned ranks ({@link com.raindropcentral.rdq2.database.entity.rank.RPlayerRank})
 *   and acquired perks ({@link com.raindropcentral.rdq2.database.entity.perk.RPlayerPerk}).</li>
 *   <li>{@link com.raindropcentral.rdq2.database.entity.bounty.RBounty} stores bounty postings and
 ...
 * </p>
 */
package com.raindropcentral.rdq2.database.entity;
