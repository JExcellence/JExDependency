 ...
 * <p>
 * Stage&nbsp;1 executor preparation (see {@link com.raindropcentral.rdq2.RDQ}) equips the
 ...
 * {@link com.raindropcentral.rdq2.RDQ#initializeViews()} run under
 * {@link com.raindropcentral.rdq2.RDQ#runSync(Runnable)}, so managers can safely read the loaded
 * system defaults while wiring UI affordances.
 * </p>
 * <p>
 * Stage&nbsp;3 assigns {@link com.raindropcentral.rdq2.database.repository.RRankRepository},
 * {@link com.raindropcentral.rdq2.database.repository.RPlayerRankUpgradeProgressRepository}, and
