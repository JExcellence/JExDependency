...
/**
 * Renders the admin job-plugin requirement integration view for storage purchases.
 *
 ...
 * @version 5.0.0
 */
public class StorageJobsView extends APaginatedView<Map<String, Object>> {

    private static final Logger LOGGER = Logger.getLogger(StorageJobsView.class.getName());
    ...
    protected @NotNull CompletableFuture<List<Map<String, Object>>> getAsyncPaginationSource(
        ...
        return CompletableFuture.completedFuture(this.detectJobPlugins());
    }
