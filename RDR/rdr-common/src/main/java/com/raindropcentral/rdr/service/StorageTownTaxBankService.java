...
/**
 * Provides support utilities for persisting and transferring town storage-tax ledger balances.
 *
 * @author ItsRainingHP
 * @since 5.0.0
 * @version 5.0.0
 */
public final class StorageTownTaxBankService {

    private static final double EPSILON = 1.0E-6D;

    private StorageTownTaxBankService() {
    }

    /**
     * Persists a successfully collected storage tax amount into the active town ledger scope.
     *
     * @param plugin active RDR runtime
     * @param payer player who paid the tax
    ...
    public static void recordCollectedTax(
        ...
        final RRTownStorageBank townStorageBankRepository = plugin.getTownStorageBankRepository();
        if (townStorageBankRepository == null) {
            return;
        }
        ...
        townStorageBankRepository.deposit(
    ...
    /**
     * Resolves whether the player can transfer ledgered storage taxes into their external town bank.
     *
    ...
    public static double transferToTownBank(
        ...
        final RTownStorageBank entry = townStorageBankRepository.findByScope(
            townScope.protectionPlugin(),
            townScope.townIdentifier(),
        ...
        return townStorageBankRepository.withdraw(
            townScope.protectionPlugin(),
            townScope.townIdentifier(),
            normalizedCurrencyType,
            transferAmount
