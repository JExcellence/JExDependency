...
/**
 * First anvil step of the GUI-only town-creation flow.
 *
 * @author ItsRainingHP
 * @since 1.0.0
 * @version 1.0.0
 */
public class CreateTownNameAnvilView extends AbstractTownCreationAnvilView {

    /**
     * Creates the town-name input view.
     */
    public CreateTownNameAnvilView() {
        super();
    }
    ...
    /**
     * Processes the entered town name.
     *
     * @param input player input
     * @param context current context
     * @return normalized town name
     */
    @Override
    ...
    /**
     * Returns whether the entered town name is valid.
     *
    ...
    /**
     * Returns the initial input shown in the anvil.
     *
    ...
    protected Map<String, Object> prepareResultData(
        ...
        resultData.put("draftTownName", result == null ? input.trim() : result);
        return resultData;
    }
}
