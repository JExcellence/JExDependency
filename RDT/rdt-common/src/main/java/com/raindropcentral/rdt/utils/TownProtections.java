...
public enum TownProtections {
    ...
    ARMORY_USE(TownProtectionCategory.ROLE_BASED, RTown.MEMBER_ROLE_ID, true, "armory_use"),
    ARMORY_BREAK(TownProtectionCategory.ROLE_BASED, RTown.MEMBER_ROLE_ID, true, "armory_break"),
    ARMORY_FURNACE_TOGGLE(TownProtectionCategory.ROLE_BASED, RTown.MEMBER_ROLE_ID, true, "armory_furnace_toggle"),
