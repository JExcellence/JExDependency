...
/**
 * Reward preview view for the dedicated town-creation flow.
 *
 * @author ItsRainingHP
 * @since 1.0.0
 * @version 1.0.0
 */
public final class TownCreationRewardsView extends BaseView {
    ...
    /**
     * Creates the town-creation reward view.
     */
    public TownCreationRewardsView() {
        super();
    }

    @Override
    protected @NotNull String getKey() {
        return "town_creation_rewards_ui";
    }
