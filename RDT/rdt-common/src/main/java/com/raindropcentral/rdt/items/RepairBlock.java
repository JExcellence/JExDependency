...
/**
 * Bound Armory repair-block item helper.
 *
 * @author ItsRainingHP
 * @since 1.0.0
 * @version 1.0.0
 */
public final class RepairBlock {

    private static final String ITEM_KIND = "repair_block";
    ...
    /**
     * Creates a bound Armory repair-block item.
     *
     ...
     */
    public static @NotNull ItemStack getRepairBlockItem(
        ...
        final ItemStack repairBlock = new ItemStack(plugin.getArmoryConfig().getRepairBlock().blockMaterial());
        final ItemMeta meta = Objects.requireNonNull(repairBlock.getItemMeta(), "repair block meta");
        meta.displayName(new I18n.Builder("repair_block.name", player)
            ...
            .build()
            .component());
        meta.lore(new I18n.Builder("repair_block.lore", player)
            .withPlaceholders(Map.of(
                "world", worldName,
                "chunk_x", chunkX,
                "chunk_z", chunkZ
        ...
        repairBlock.setItemMeta(meta);
        return repairBlock;
    }

    /**
     * Returns whether an item is a bound repair-block payload.
     *
     * @param plugin active plugin runtime
     * @param item item to inspect
     * @return {@code true} when the item is a bound repair block
     */
