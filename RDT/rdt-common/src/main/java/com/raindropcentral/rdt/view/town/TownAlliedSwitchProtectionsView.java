...
/**
 * Dedicated editor for allied switch-action access, including a bulk action and paginated
 ...
 * @version 1.0.0
 */
public class TownAlliedSwitchProtectionsView extends AbstractTownProtectionView {

    public static final String VIEW_KEY = "allied_switch_actions";

    private static final String PAGE_KEY = "allied_switch_page";
    ...
    /**
     * Creates the allied switch-action protections editor.
     */
    public TownAlliedSwitchProtectionsView() {
    ...
    protected @NotNull String getKey() {
        return "town_allied_switch_protections_ui";
    }
    ...
    private void openPage(final @NotNull SlotClickContext clickContext, final int page) {
        clickContext.openForPlayer(TownAlliedSwitchProtectionsView.class, this.createSwitchNavigationData(clickContext, page));
    }
