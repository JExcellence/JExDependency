...
/**
 * First anvil step of the GUI-only nation-creation flow.
 *
 * @author ItsRainingHP
 * @since 1.0.0
 * @version 1.0.0
 */
public final class CreateNationNameAnvilView extends AbstractTownNationAnvilView {

    /**
     * Creates the nation-name input view.
     */
    public CreateNationNameAnvilView() {
        super();
    }

    @Override
    protected @NotNull String getKey() {
        return "town_nation_create_name_ui";
    }
    ...
    protected @NotNull Map<String, Object> prepareResultData(
        ...
        resultData.put(
            TownNationViewSupport.DRAFT_NATION_NAME_KEY,
