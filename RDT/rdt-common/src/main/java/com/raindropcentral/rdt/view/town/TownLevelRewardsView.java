...
/**
 * Shared reward-preview view for Nexus and Security levels.
 *
 * @author ItsRainingHP
 * @since 1.0.0
 * @version 1.0.0
 */
public final class TownLevelRewardsView extends BaseView {
    ...
    /**
     * Creates the shared reward-preview view.
     */
    public TownLevelRewardsView() {
        super();
    }

    @Override
    protected @NotNull String getKey() {
        return "town_level_rewards_ui";
    }
