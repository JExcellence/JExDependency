 ...
 * @version 1.0.0
 */
public class ShopSkillsView extends APaginatedView<Map<String, Object>> {

    private static final Logger LOGGER = Logger.getLogger(ShopSkillsView.class.getName());
    ...
    protected @NotNull java.util.concurrent.CompletableFuture<List<Map<String, Object>>> getAsyncPaginationSource(
        ...
        return java.util.concurrent.CompletableFuture.completedFuture(this.detectSkillPlugins());
    }
