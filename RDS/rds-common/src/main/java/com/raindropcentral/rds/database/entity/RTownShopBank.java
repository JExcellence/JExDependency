...
/**
 * Persistent town-owned ledger entry for collected RDS protection taxes.
 *
...
@Entity
@Table(
        name = "rds_town_shop_bank",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_rds_town_shop_bank_scope",
