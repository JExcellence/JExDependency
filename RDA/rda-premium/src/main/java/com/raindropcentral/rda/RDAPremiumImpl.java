...
/**
 * Delegate implementation for the RDA premium edition.
 *
 * <p>This class owns the edition-specific bootstrap wiring and instantiates the shared
 * {@link RDA} runtime for the premium edition.</p>
 *
 * @author ItsRainingHP
 * @since 1.0.0
 * @version 1.0.0
 */
public final class RDAPremiumImpl extends AbstractPluginDelegate<RDAPremium> {

    private static final Logger LOGGER = Logger.getLogger(RDAPremiumImpl.class.getName());
     ...
     */
    public RDAPremiumImpl(final @NotNull RDAPremium plugin) {
        super(plugin);
    }

    /**
     * Creates the shared RDA runtime for the premium edition.
     */
    @Override
    public void onLoad() {
        try {
