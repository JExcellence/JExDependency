 ...
 * <p>
 * This enum controls the trade-off between maximum compatibility with all Bedrock clients
...
public enum BedrockFormatMode {
     ...
     * <p>
     * This mode ensures messages display correctly on all Bedrock Edition clients,
     ...
     * <p>
     * Supported formatting in this mode:
     * <ul>
     ...
     * </ul>
     * <p>
     * This is the recommended mode for production servers with diverse player bases.
     */
    CONSERVATIVE,
     ...
     * <p>
     * Some newer Bedrock versions and certain proxy setups (Geyser/Floodgate) may support
     ...
     * <p>
     * <strong>Warning:</strong> This mode may result in broken or missing formatting on
     ...
     * <p>
     * Additional features attempted in this mode:
     * <ul>
     *   <li>Hex colors (preserved as-is)</li>
     *   <li>Gradients (character-by-character coloring)</li>
     * </ul>
     * <p>
     * Still stripped (not supported on any Bedrock client):
     * <ul>
     *   <li>Click events</li>
     *   <li>Hover events</li>
     *   <li>Custom fonts</li>
