 ...
 *
 * <p>Bedrock Edition clients have limited color support compared to Java Edition. While Java Edition
 ...
 *
 * <p>Text that was colored with hex codes will appear in the default color (usually white).
     * This is the safest option but results in loss of color information.
 *
 * <p>Example: {@code <#FF5733>Hello</color>} becomes {@code Hello}
     */
    STRIP,
 ...
 *
 * <p>Uses Euclidean distance in RGB color space to find the closest of the 16 legacy colors.
     * This preserves the general color intent while ensuring Bedrock compatibility.
 *
 * <p>Example: {@code <#FF5733>Hello</color>} becomes {@code §6Hello} (gold, the nearest legacy color)
     */
    NEAREST_LEGACY,
 ...
 *
 * <p>Calculates the luminance of the hex color and maps it to one of three grayscale
 ...
 *
 * <p>Example: {@code <#FF5733>Hello</color>} becomes {@code §7Hello} (gray)
     */
    GRAYSCALE
}
