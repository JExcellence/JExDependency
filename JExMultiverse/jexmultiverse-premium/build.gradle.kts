...
version = "1.0.0"
description = "JExMultiverse Premium - Premium edition of JExMultiverse"
...
tasks.named<ShadowJar>("shadowJar") {
    ...
    from(project(":JExMultiverse:jexmultiverse-common").sourceSets.main.get().resources)
}
