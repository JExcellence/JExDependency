...
/**
 * Main plugin class for JExMultiverse Free Edition.
 * <p>
 * This class serves as the entry point for the Bukkit plugin system and delegates all
 * functionality to {@link JExMultiverseFreeImpl}. The delegate handles the staged enable pipeline:
...
public final class JExMultiverseFree extends JavaPlugin {
    ...
    private JExMultiverseFreeImpl impl;

    @Override
    public void onLoad() {
        try {
            JEDependency.initializeWithRemapping(this, JExMultiverseFree.class);
            impl = new JExMultiverseFreeImpl(this);
            impl.onLoad();
